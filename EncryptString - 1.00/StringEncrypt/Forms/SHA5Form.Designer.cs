...
partial class SHA5Form
{
    ...
    private void InitializeComponent()
    {
        ...
        LabEncry.Text =  "Text with Secure Hash Algorithm: SHA-512-bit encryption";
        LabEncry.TabIndex = 3;
        // TBxEncry
        ...
        MsgBox.SetToolTip(BtnEncry, "Encrypt text with Secure Hash Algorithm: SHA-512-bit");
        MsgBox.SetToolTip(BtnClear, "Clear controls");
        MsgBox.SetToolTip(BtnCopyE, "Copy text with Secure Hash Algorithm: SHA-512-bit encryption");
        // Form
