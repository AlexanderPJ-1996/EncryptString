...
partial class AESForm
{
    ...
    private Label LabKey1;
    private TextBox TBxKey;
    private Label LabKey2;
    private Label LabIV1;
    private TextBox TBxIV;
    private Label LabIV2;
    ...
    private void InitializeComponent()
    {
        ...
        PanCtrls.BackColor = Color.Transparent;
        ...
        // LabKey1
        LabKey1.Location = new Point(20,80);
        LabKey1.AutoSize =  true;
        LabKey1.Font = new Font("Segoe UI", 12F, FontStyle.Bold, GraphicsUnit.Point);
        LabKey1.ForeColor = Color.Black;
        LabKey1.Name =  "LabKey1";
        LabKey1.Text =  "Encryption Key:";
        LabKey1.TabIndex = 1;
        // TBxKey
        TBxKey.Location = new Point(195,80);
        TBxKey.Size = new Size(400,29);
        TBxKey.MaxLength = 32;
        TBxKey.BorderStyle = BorderStyle.FixedSingle;
        TBxKey.BackColor = SystemColors.ActiveCaption;
        TBxKey.Name = "TBxKey";
        TBxKey.Text = string.Empty;
        TBxKey.TabIndex = 2;
        TBxKey.TextChanged += new EventHandler(TxTKey);
        // LabKey2
        LabKey2.Location = new Point(605,80);
        LabKey2.AutoSize =  true;
        LabKey2.Font = new Font("Segoe UI", 12F, FontStyle.Bold, GraphicsUnit.Point);
        LabKey2.ForeColor = Color.Black;
        LabKey2.Name =  "LabKey2";
        LabKey2.Text =  "0/32";
        LabKey2.TabIndex = 3;
        // LabIV1
        LabIV1.Location = new Point(20,120);
        LabIV1.AutoSize =  true;
        LabIV1.Font = new Font("Segoe UI", 12F, FontStyle.Bold, GraphicsUnit.Point);
        LabIV1.ForeColor = Color.Black;
        LabIV1.Name =  "LabIV1";
        LabIV1.Text =  "Initialization Vector:";
        LabIV1.TabIndex = 4;
        // TBxIV
        TBxIV.Location = new Point(195,120);
        TBxIV.Size = new Size(400,29);
        TBxIV.MaxLength = 16;
        TBxIV.BorderStyle = BorderStyle.FixedSingle;
        TBxIV.BackColor = SystemColors.ActiveCaption;
        TBxIV.Name = "TBxIV";
        TBxIV.Text = string.Empty;
        TBxIV.TabIndex = 5;
        TBxIV.TextChanged += new EventHandler(TxTIV);
        // LabIV2
        LabIV2.Location = new Point(605,120);
        LabIV2.AutoSize =  true;
        LabIV2.Font = new Font("Segoe UI", 12F, FontStyle.Bold, GraphicsUnit.Point);
        LabIV2.ForeColor = Color.Black;
        LabIV2.Name =  "LabIV2";
        LabIV2.Text =  "0/16";
        LabIV2.TabIndex = 6;
        // LabNocry
        LabNocry.Location = new Point(20,170);
        ...
        LabNocry.TabIndex = 7;
        // TBxNocry
        TBxNocry.Location = new Point(20,195);
        ...
        TBxNocry.TabIndex = 8;
        // LabEncry
        LabEncry.Location = new Point(20,240);
        ...
        LabEncry.Text =  "Text with AES (Advanced Encryption Standard) encryption";
        LabEncry.TabIndex = 9;
        // TBxEncry
        TBxEncry.Location = new Point(20,265);
        TBxEncry.Multiline = true;
        TBxEncry.ScrollBars = ScrollBars.Vertical;
        TBxEncry.Size = new Size(760,220);
        ...
        TBxEncry.TabIndex = 10;
        // BtnCopyE
        BtnCopyE.Location = new System.Drawing.Point(790,265);
        ...
        LabDecry.Text =  "Text with AES (Advanced Encryption Standard) decryption";
        LabDecry.TabIndex = 12;
        // TBxDecry
        ...
        BtnCopyD.TabIndex = 14;
        BtnCopyD.Click += new EventHandler(CopyDTxT);
        // MsgBox
        MsgBox.IsBalloon = true;
        MsgBox.SetToolTip(BtnEncry, "Encrypt text with AES (Advanced Encryption Standard)");
        MsgBox.SetToolTip(BtnDecry, "Decrypt text with AES (Advanced Encryption Standard)");
        MsgBox.SetToolTip(BtnClear, "Clear controls");
        MsgBox.SetToolTip(BtnClear, "Clear controls");
        MsgBox.SetToolTip(BtnCopyE, "Copy text with AES (Advanced Encryption Standard) encryption");
        MsgBox.SetToolTip(BtnCopyD, "Copy text with AES (Advanced Encryption Standard) decryption");
        // Form
