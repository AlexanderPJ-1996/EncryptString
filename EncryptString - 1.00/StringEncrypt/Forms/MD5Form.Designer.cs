...
partial class MD5Form
{
    ...
    private void InitializeComponent()
    {
        ...
        LabEncry.Text =  "Text with Secure Hash Algorithm: MD5 encryption";
        LabEncry.TabIndex = 3;
        // TBxEncry
        ...
        MsgBox.SetToolTip(BtnEncry, "Encrypt text with Secure Hash Algorithm: MD5");
        MsgBox.SetToolTip(BtnClear, "Clear controls");
        MsgBox.SetToolTip(BtnCopyE, "Copy text with Secure Hash Algorithm: MD5 encryption");
        // Form
